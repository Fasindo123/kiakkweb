                ...
                <div class="row">
                  <div class="col-lg-4 col-sm-6 grow-up">
                    <div class="box-logo parallax-item">
                      <img class="cm-img-0" src="assets/imgs/támogatók/kometa.jpg" alt="Kométa 99 Élelmiszeripari Zrt." title="Kométa 99 Élelmiszeripari Zrt.">
                      <img class="cm-img-900" src="assets/imgs/támogatók/kometa.jpg" alt="Kométa 99 Élelmiszeripari Zrt." title="Kométa 99 Élelmiszeripari Zrt.">
                    </div>
                  </div>
                  <div class="col-lg-4 col-sm-6 grow-up">
                    <div class="box-logo parallax-item">
                      <img class="cm-img-0" src="assets/imgs/támogatók/kszc.png" alt="Kaposvári Szakképzési Centrum" title="Kaposvári Szakképzési Centrum">
                      <img class="cm-img-900" src="assets/imgs/támogatók/kszc.png" alt="Kaposvári Szakképzési Centrum" title="Kaposvári Szakképzési Centrum">
                    </div>
                  </div>
                  <div class="col-lg-4 col-sm-6 grow-up">
                    <div class="box-logo parallax-item">
                      <img class="cm-img-0" src="assets/imgs/támogatók/kaposvar.jpg" alt="Kaposvár Megyei Jogú Város Önkormányzata" title="Kaposvár Megyei Jogú Város Önkormányzata">
                      <img class="cm-img-900" src="assets/imgs/támogatók/kaposvar.jpg" alt="Kaposvár Megyei Jogú Város Önkormányzata" title="Kaposvár Megyei Jogú Város Önkormányzata">
                    </div>
                  </div>
                  <div class="col-lg-4 col-sm-6 grow-up">
                    <div class="box-logo parallax-item">
                      <img class="cm-img-0" src="assets/imgs/támogatók/bazisinfo.jpg" alt="Bázis Informatika Kft" title="Bázis Informatika Kft">
                      <img class="cm-img-900" src="assets/imgs/támogatók/bazisinfo.jpg" alt="Bázis Informatika Kft" title="Bázis Informatika Kft">
                    </div>
                  </div>
                  <div class="col-lg-4 col-sm-6 grow-up">
                    <div class="box-logo parallax-item">
                      <img class="cm-img-0" src="assets/imgs/támogatók/precognox.png" alt="Precognox Informatikai Kft" title="Precognox Informatikai Kft">
                      <img class="cm-img-900" src="assets/imgs/támogatók/precognox.png" alt="Precognox Informatikai Kft" title="Precognox Informatikai Kft">
                    </div>
                  </div>
                </div>             
              </div>
