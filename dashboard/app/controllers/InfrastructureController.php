...
class InfrastructureController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$this->view->search_template = "infrastructure/search.php";
		}
		if(!empty($request->orderby)){
			...
			$db->orderBy("infrastructure.id", ORDER_TYPE);
		}
		if($fieldname){
		...
		$this->render_view("infrastructure/list.php", $data); //render the full page
	}
	/**
     * View record detail 
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("infrastructure.id", $rec_id);; //select record based on primary key
		}
		...
		return $this->render_view("infrastructure/view.php", $record);
	}
	/**
	...
	function edit($rec_id = null, $formdata = null){
		...
		return $this->render_view("infrastructure/edit.php", $data);
	}
	/**
     * Update single field
	 * @param $rec_id (select record by table primary key)
