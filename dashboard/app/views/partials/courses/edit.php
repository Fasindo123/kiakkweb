                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-title"  value="<?php  echo $data['title']; ?>" type="text" placeholder="Adj elnevezést a képzésnek!"  required="" name="title"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-short_description"  value="<?php  echo $data['short_description']; ?>" type="text" placeholder="Adj meg rövid leírást!"  required="" name="short_description"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <textarea placeholder="Készítsd el a hosszú leírás oldalát!" id="ctrl-long_description"  required="" rows="5" name="long_description" class="htmleditor form-control"><?php  echo $data['long_description']; ?></textarea>
