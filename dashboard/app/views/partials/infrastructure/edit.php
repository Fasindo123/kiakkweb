            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("infrastructure/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <textarea placeholder="Adj meg rövid leírást!" id="ctrl-short_description"  required="" rows="5" name="short_description" class=" form-control"><?php  echo $data['short_description']; ?></textarea>
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <div class="dropzone required" input="#ctrl-more_imgs" fieldname="more_imgs"    data-multiple="false" dropmsg="Válassz képet vagy húzd ide!"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1000">
                                                            <input name="more_imgs" id="ctrl-more_imgs" required="" class="dropzone-input form-control" value="<?php  echo $data['more_imgs']; ?>" type="text"  />
                                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                            </div>
                                                        </div>
                                                        <?php Html :: uploaded_files_list($data['more_imgs'], '#ctrl-more_imgs', 'true'); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
