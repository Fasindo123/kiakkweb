                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <input class="form-control" placeholder="Név" id="nev" name="nev" required>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      <input class="form-control" placeholder="Telefonszám" id="telefonszam" name="telefonszam" oninput="formatTelefonszam(this)" required>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <input class="form-control" placeholder="Tárgy" id="targy" name="targy" required></input>
                    </div>
                  </div>
                  <div class="col-lg-12">
                    <div class="form-group">
                      <textarea class="form-control" placeholder="Üzenet" id="uzenet" name="uzenet" oninput="uzenetdoboz(this);" required></textarea>
                    </div>
                  </div>
                  <div class="col-lg-12">
                    <div class="box-button-touch">
                      <div class="form-group">
                        <button class="btn btn-black" type="submit" name="Submit" index="Submit" onclick="return sendForm();">Küldés <img src="assets/imgs/template/icons/arrow.svg" alt="küldés icon"></button>
                      </div>
